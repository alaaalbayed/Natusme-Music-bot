module.exports = {
  ...
  embed: {
    color: process.env.color || "#D1B2FF",
    wrongcolor: process.env.wrongcolor || "#D1B2FF",
    footertext: "Coding By Aizen",
  },
  emoji: {
    ERROR: "❌",
    SUCCESS: "✅",
  ...
  links: {
    inviteURL:
      ...
      `https://discord.com/oauth2/authorize?client_id=996299474265714768&permissions=8&scope=bot`,
    DiscordServer: process.env.DiscordServer || `https://discord.gg/3bfjtQrH`,
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true,
  ...
  slash: {
    global: true,
    guildID: process.env.GUILD_ID || "1074894058197090305", // for slash command
  },
